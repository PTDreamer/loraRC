...
class RH_RF22JB : public RHSPIDriver
{
public:
    ...
    RH_RF22JB(uint8_t slaveSelectPin = SS, uint8_t interruptPin = 2, RHGenericSPI& spi = hardware_spi);
    ...
    void        getModemConfig(ModemConfigChoice index, ModemConfig *cnf);
...
public:
    void setRadioFSM(RadioFSM *fsm);
    void setRadioID(int val);
protected:
    ...
    static RH_RF22JB*     _deviceForInterrupt[];
